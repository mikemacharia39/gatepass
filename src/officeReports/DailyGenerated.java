...
public class DailyGenerated extends Application {
    ...
    TableColumn<Reports, String> namecol, admcol, timecol, datecol;
    Stage stage;
    Scene scene;
    ...
    public void start(Stage manual) throws Exception {
        ...
        //stage.getIcons().add(new Image("/pic/logo.png"));
        ...
        ltitle = new Label("Daily Office Reports From " + DailyReportso.txtdate.getValue().toString() + " To "
                + DailyReportso.txtdate1.getValue().toString());
        ...
        table.getColumns().addAll(namecol, admcol, timecol, datecol);
        ...
        scene.getStylesheets().add(DailyReportso.class.getResource("reports.css").toExternalForm());
        stage.setX(270);
        stage.setY(28);
    ...
    public ObservableList<Reports> getAtt() {
        ...
        String sql = "SELECT first_name, staff_id, time_in, date FROM  officeentry"
                + " WHERE date BETWEEN '" + DailyReportso.txtdate.getValue().toString() + "'"
                + " AND '" + DailyReportso.txtdate1.getValue().toString() + "'";
        try {
            DBConnect.connect();
            ...
            while ((rec != null) && (rec.next())) {
                ...
                list.add(new Reports(name, adm, timein, date));
            }
            rec.close();
