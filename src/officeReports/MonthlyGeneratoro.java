...
public class MonthlyGeneratoro extends Application{
	...
	public void start(Stage dr) throws Exception {
		...
		ltitle.setStyle("-fx-text-fill: white");
		...
		cyear.getItems().addAll("2016","2017","2018","2019","2020","2021","2022","2023","2024","2025");
       ...
       // lay3.setStyle("-fx-background-color:#00aaff; -fx-background-radius:1;");
        ...
        scene.getStylesheets().add(MonthlyGeneratoro.class.getResource("reports.css").toExternalForm());
