    ...
    public void openMainPage() {
        ...
        if (txtname.getText().equals("") || txtpass.getText().equals("")) {
            ...
            try {
                ...
                if (rs.next()) {
                    if (rs.getString("username").equals(txtname.getText()) && rs.getString("password").equals(txtpass.getText())) {
                        try {
                            window.close();
                        ...
                        errormessage.setVisible(false);
                    } else if (rs.getString("username").equals(txtname.getText()) && rs.getString("password") != txtpass.getText()) {
